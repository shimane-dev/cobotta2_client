...
"""
from cobotta2 import Config, CobottaState
from cobotta2.server import CobottaRouterState, cobotta_state_api_spec
...
if __name__ == "__main__":
    Config.load_yaml("../config_cobotta2_state.yaml")
    logger = XLogger(
        log_level="debug",
        logger_name=Config.SERVER_LOGGER_NAME,
        log_mode="rotate",
        # log_mode="file",
        log_name="c:/opt/log/cobotta2_server2_state.log",
    )
